> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.ruanyifeng.com](https://www.ruanyifeng.com/blog/2016/04/same-origin-policy.html)
...
> ```
> var win = document.getElementsByTagName('iframe')[0].contentWindow;
> var obj = { name: 'Jack' };win.postMessage(JSON.stringify({key: 'storage', method: 'set', data: obj}), 'http://bbb.com');win.postMessage(JSON.stringify({key: 'storage', method: "get"}), "*");
> window.onmessage = function(e) {
...
下一篇文章，我会详细介绍，如何通过 [CORS](https://www.ruanyifeng.com/blog/2016/04/cors.html) 完成跨源 AJAX 请求。
